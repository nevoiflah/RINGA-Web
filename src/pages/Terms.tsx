  ...
  he: {
    ...
    body: (
      <>
        ...
        <P>
          Nearby עשוי להציג משתמשים הנמצאים ברדיוס מרבי של כ־200 מטר, נכון להיום. RINGA אינה מציגה
          במסגרת חוויית Nearby הרגילה את המרחק המדויק של משתמש אחר.
        </P>
        <P>
          ...
          אדם שמופיע ב־Nearby עשוי כבר לעבור למקום אחר, להפוך ללא זמין, לשנות את הגדרות הפרטיות שלו
