  ...
  he: {
    ...
    body: (
      <>
        ...
        <H3>4.5 Nearby</H3>
        <P>
          פונקציית Nearby של RINGA נועדה לסייע למשתמשים לגלות משתמשים אחרים הנמצאים בקרבת מקום.
          הרדיוס המרבי של Nearby הוא כיום כ־200 מטר. RINGA אינה מציגה לכם את המרחק המדויק של
          משתמש אחר.
        </P>
        <P>
          המידע המוצג ב־Nearby עשוי להשתנות כאשר משתמשים זזים, משנים הגדרות פרטיות, מפעילים Ghost
          ...
          שאינם בשליטת RINGA. לכן, הופעת משתמש ב־Nearby אינה מהווה אישור למיקומו הפיזי המדויק.
        </P>
