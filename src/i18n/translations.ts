    ...
    story: {
      scenes: {
        ...
        rooms: {
          ...
          desc: "הצטרפו ל־אירוע דרך QR או קישור, גלו מי כאן ושלחו Like. יש Like הדדי? יש Match ואפשר לדבר. ללא GPS, גם אחרי שיצאתם. ברירת המחדל היא 24 שעות; שעת הסיום מופיעה באירוע.",
        },
        delay: {
          n: "03",
          eyebrow: "הודעה ראשונה מושהית",
          title: "ההודעה הראשונה מחכה",
          desc: "אופן שליחת הודעה: אתה בוחר השהיה - עד 8 שעות. בלי לחץ, בלי ספאם, רק כוונה אמיתית.",
        },
        chat: {
          n: "04",
